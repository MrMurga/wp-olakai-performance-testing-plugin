...
define ('WP_OLAKAI_PERFORMANCE_TESTING_TRANSIENT_SERVER', WP_OLAKAI_PERFORMANCE_TESTING_PLUGIN_NAME . '-ping');
define ('WP_OLAKAI_PERFORMANCE_TESTING_TRANSIENT_SERVER_TTL_SECS', 60 * 15);
