...
require_once plugin_dir_path( __FILE__ ) . '/class-wp-olakai-performance-testing-plugin-actions.php';
require_once plugin_dir_path( __FILE__ ) . '/class-wp-olakai-performance-testing-plugin-network-utilities.php';
 ...
 */
class Wp_Olakai_Performance_Testing_Plugin {
	...
	public function __construct() {
		if ( defined( 'WP_OLAKAI_PERFORMANCE_TESTING_PLUGIN_VERSION' ) ) {
			$this->version = WP_OLAKAI_PERFORMANCE_TESTING_PLUGIN_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wp-olakai-performance-testing-plugin';
	 ...
	 *
	 * - Wp_Olakai_Performance_Testing_Plugin_Loader. Orchestrates the hooks of the plugin.
	 * - Wp_Olakai_Performance_Testing_Plugin_i18n. Defines internationalization functionality.
	 * - Wp_Olakai_Performance_Testing_Plugin_Admin. Defines all hooks for the admin area.
	 * - Wp_Olakai_Performance_Testing_Plugin_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-olakai-performance-testing-plugin-loader.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-olakai-performance-testing-plugin-filters.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-olakai-performance-testing-plugin-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wp-olakai-performance-testing-plugin-admin.php';
	 ...
	 *
	 * Uses the Wp_Olakai_Performance_Testing_Plugin_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Wp_Olakai_Performance_Testing_Plugin_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wp_Olakai_Performance_Testing_Plugin_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wp_Olakai_Performance_Testing_Plugin_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wp_Olakai_Performance_Testing_Plugin_Loader    Orchestrates the hooks of the plugin.
	 */
